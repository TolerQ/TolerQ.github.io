...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $conn = mysqli_connect("localhost", "Anna", "zaq1@WSX", "komis1");
...
echo <<<ROW
      <tr>
        ...
        <td><a href="./?update_id=$row[id]">Update</a></td>
      </tr>
ROW;
    }
    mysqli_close($conn);
...
<hr>Aktualizacja tabeli user</hr>
<?php
...
<form action="./script/update_user.php" method="post">
  ...
  <input type="submit" name="button" value="Zaktualizuj użytkownika">
</form>
